...
@section('content')
    <div class="mb-3">
        ...
        <h1 class="h3 mb-0 mt-2">Add User</h1>
    </div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        <div class="form-check mt-4">
                            <input class="form-check-input" id="is_admin" name="is_admin" type="checkbox" value="1" {{ old('is_admin') ? 'checked' : '' }}>
                    ...
                    <div class="col-md-6">
                        <div class="form-check mt-4">
                            <input class="form-check-input" id="is_instructor" name="is_instructor" type="checkbox" value="1" {{ old('is_instructor') ? 'checked' : '' }}>
