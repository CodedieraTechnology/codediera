                        ...
                        <tr>
                            ...
                            <td>
                                @if($role->slug === 'super_admin')
                                    <span class="badge bg-success text-white">All Permissions (Bypassed)</span>
                                @else
                                    @forelse($role->permissions as $perm)
                                        <span class="badge bg-secondary text-white mb-1" style="font-size: 0.75rem;">{{ $perm->name }}</span>
                                    @empty
                            ...
                            <td class="text-end pe-4">
                                <div class="d-flex justify-content-end gap-2">
                                    <a class="btn btn-sm btn-outline-primary" href="{{ route('admin.roles.edit', $role) }}" title="Edit" aria-label="Edit">
